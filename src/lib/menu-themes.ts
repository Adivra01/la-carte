...
export const MENU_THEMES: MenuTheme[] = [
  ...
  },
  {
    id: "lagon",
    label: "Lagon",
    hint: "Bleu pétrole et corail — frais, moderne, bord de mer",
    bg: "#073B4C",
    surface: "#0B4B5E",
    text: "#F4FBFA",
    muted: "#AED5D2",
  ...
  },
  {
    id: "soleil",
    label: "Soleil",
    hint: "Jaune safran et prune — vivant, populaire, généreux",
    bg: "#FFF8E7",
    surface: "#FFFFFF",
    text: "#34202C",
    muted: "#806A73",
  ...
  },
  {
    id: "braise",
    label: "Braise",
    hint: "Rouge profond et ivoire — audacieux, grillades, signature",
    bg: "#351416",
    surface: "#491C1E",
    text: "#FFF4E8",
    muted: "#D5B8AC",
